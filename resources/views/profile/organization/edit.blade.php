            ...
            <div class="row">
                    ...
                    <div class="sticky-top">
                        ...
                        <nav>
                            <div class="nav nav-pills nav-pills-warning flex-column" id="profilePages" role="tablist">
                                ...
                                <a class="nav-item nav-link active" id="nav-odetails-tab" data-toggle="tab"
                                   href="#nav-odetails"
                ...
                <div class="col-md-9">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-odetails" role="tabpanel"
                             aria-labelledby="nav-odetails-tab">
